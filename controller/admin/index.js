...
router.get('/product_table', controller.produtableIndex);
// router.get('/product_table/:id',controller.productdeleteIndex);
...
router.post('/add', (req, res) => {
    ...
    data.then((db) => {
        db.collection('catagory').insertOne(params).then((result) => {
